...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Instructor.avatar'
        db.alter_column('instructors', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Instructor.avatar'
        db.alter_column('instructors', 'avatar', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100))
